          ...
          SingleChildScrollView(
            ...
            child: Column(children: [
              _PracticeOptionCard(
                ...
                subtitleFa: 'بازی ساخت کلمه از روی معنی و تلفظ',
                color: const Color(0xFF00E5A0),
                onTap: () => _pickThen(context, (l) => WordBuilderPage(lesson: l)),
              ),
              const SizedBox(height: 16),
              _PracticeOptionCard(
                emoji: '📝',
                ...
                subtitleFa: 'جمله‌ی انگلیسی رو از روی معنی بساز',
                color: const Color(0xFF7C4DFF),
                onTap: () => _pickThen(context, (l) => SentenceBuilderPage(lesson: l)),
              ),
              const SizedBox(height: 16),
              _PracticeOptionCard(
                emoji: '🗣️',
...
class _WordBuilderPageState extends State<WordBuilderPage> {
  ...
  void _rebuildPool() {
    pool = currentLesson != null
        ? (List<Word>.from(currentLesson!.words)..shuffle())
...
class _SentenceBuilderPageState extends State<SentenceBuilderPage> {
  ...
  void _rebuildSentences() {
    final allExamples = currentLesson != null
        ? (List<String>.from(currentLesson!.examples)..shuffle())
  ...
  void _next() {
    if (round + 1 >= englishSentences.length) {
      if (currentLesson != null) {
        AppState.instance.markActivityComplete(currentLesson!.id, 'sentences');
        AppState.instance.addReward(20, 5);
      }
      Navigator.pop(context);
      return;
