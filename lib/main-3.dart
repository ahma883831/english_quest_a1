...
class _LessonPageState extends State<LessonPage> {
  ...
  Widget _quiz() {
    ...
    if (quizIndex >= questions.length) return _quizComplete();
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Directionality(
              textDirection: TextDirection.rtl,
              child: Text(
                quizIndex + 1 >= total ? 'پایان آزمون' : 'بعدی',
            ...
            child: Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                const Directionality(
                  textDirection: TextDirection.rtl,
                  child: Text('تبریک!', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Colors.amber)),
                ),
                const SizedBox(height: 8),
                const Directionality(
                  textDirection: TextDirection.rtl,
                  child: Text('درس را با موفقیت کامل کردی', style: TextStyle(fontSize: 16, color: Colors.white70)),
                ),
                const SizedBox(height: 6),
                Text('Score: $score / ${widget.lesson.questions.length}', style: const TextStyle(color: Color(0xFF00E5FF), fontSize: 14)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Directionality(
                      textDirection: TextDirection.rtl,
                      child: Text(rewardClaimed ? 'جایزه دریافت شد ✅' : 'ادامه', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    ),
                  ),
                ),
                const SizedBox(height: 10),
